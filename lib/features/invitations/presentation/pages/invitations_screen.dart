...
class _InvitationsScreenState extends State<InvitationsScreen> {
                    ...
                    SizedBox(
                      ...
                      child: PageView.builder(
                        ...
                        itemBuilder: (context, index) {
                          if (index == 1) {
                            // Replace the second card with a "Coming Soon" feature
                            return Container(
                              ...
                              child: Center(
                                child: Text(
                                  "سيتوفر قريبًا المزيد من الكروت",
                                  style: GoogleFonts.cairo(
  ...
  // Added null checks for card data to prevent rendering invalid cards

  Widget _buildBalanceCard(Map<String, dynamic> card) {
    // Validate card data
    if (card['Used_invitations'] == null ||
        card['Remaining_invitations'] == null ||
        card['color'] == null ||
        card['type'] == null ||
        card['expiry'] == null) {
      return Container(
