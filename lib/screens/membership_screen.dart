        ...
        child: Column(
          ...
          children: [
            ...
            if (membership.wives.isNotEmpty) ...[
              ...
              ...membership.wives.map(
                (wife) => _buildDependentTile(context, wife),
              ),
            ...
            if (membership.children.isNotEmpty) ...[
              ...
              ...membership.children.map(
                (child) => _buildDependentTile(context, child),
              ),
            ],
          ],
        ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          CircleAvatar(
            radius: 40,
            backgroundImage: NetworkImage(membership.photoUrl),
          ),
          ...
          Text(
            membership.job,
            style: TextStyle(color: Color.fromARGB(255, 255, 255, 100)),
          ),
          ...
          Row(
            ...
            children: [
              ...
              _infoItem('نوع العضوية', membership.membershipType),
    ...
    return Card(
      ...
      child: ListTile(
        ...
        onTap: () => Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => DependentScreen(dependent: dependent),
          ),
        ),
      ),
    );
